...
import "./ATSConnector.sol";
import "../extensions/ATSFeeModule.sol";

/**
 * @notice Extends ATSConnector to implement fee collecting for crosschain ERC20 token bridging.  
 */
contract ATSConnectorWithFee is ATSConnector, ATSFeeModule {
     ...
     */
    function _authorizeCall() internal override(ATSConnector, ATSFeeModule) onlyRole(DEFAULT_ADMIN_ROLE) {
